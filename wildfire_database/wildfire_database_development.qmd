...
Workflow indicates ingesting file with median EVI data locally. In fact, the
file was beyond what is appropriate to store under version control and is
instead stored externally; the code here is retained for reference. Link to file
in Goole Drive: 
