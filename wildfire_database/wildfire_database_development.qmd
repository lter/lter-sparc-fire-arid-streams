...
Flowlines are generated only for catchments that make it into the analyses set.
Here we document only creating the table, populating the table is a separate
workflow. Note that this table does not have a primary key.
