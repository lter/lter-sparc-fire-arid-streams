...
wildfire event per watershed (`usgs_site`) that meets strict pre- and
post-fire data quality criteria for water quality analysis. It enables
fast, repeatable queries for analyzing wildfire impacts on nitrate and
discharge patterns.
...
wildfire that also meets nitrate-discharge data sufficiency criteria. It
