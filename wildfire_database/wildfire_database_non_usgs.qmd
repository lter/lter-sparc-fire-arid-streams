...
(
  non_usgs <- readr::read_csv("non_usgs_data.csv") |> 
    janitor::clean_names() |> 
...
hanan_bell_pour_points <- dplyr::bind_rows(
  sf::st_read("~/localRepos/lter-sparc-fire-arid-streams/data/hanan_bell_3_pp.geojson") |> 
    dplyr::rename(usgs_site = Name) |> 
    dplyr::mutate(usgs_site = "hanan_bell_3"),
  sf::st_read("~/localRepos/lter-sparc-fire-arid-streams/data/hanan_bell_4_pp.geojson") |> 
    dplyr::rename(usgs_site = Name) |> 
...
hanan_bell_catchments <- dplyr::bind_rows(
  sf::st_read("~/localRepos/lter-sparc-fire-arid-streams/data/hanan_bell_3_ws.geojson") |> 
    dplyr::rename(usgs_site = Name) |> 
    dplyr::mutate(usgs_site = "hanan_bell_3"),
  sf::st_read("~/localRepos/lter-sparc-fire-arid-streams/data/hanan_bell_4_ws.geojson") |> 
    dplyr::rename(usgs_site = Name) |> 
    dplyr::mutate(usgs_site = "hanan_bell_4")
) |> 
