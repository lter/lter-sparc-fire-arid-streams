...
Function to create a materialized view that identifies the largest wildfire
event per watershed (`usgs_site`) that meets strict pre- and post-fire data
quality criteria for water quality analysis. It enables fast, repeatable queries
for analyzing wildfire impacts on nitrate and discharge patterns.
...
also meets nitrate-discharge data sufficiency criteria. It ensures that only
