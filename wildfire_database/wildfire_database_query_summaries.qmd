...
Note that data pertaining to the following sites are added manually because they fall outside of
...
'data/sbc_redb_ecos.csv' was generated manually in qgis by intersecting the
catchment boundaries of e.g., the sbc sites and redb with the [ecoregions
